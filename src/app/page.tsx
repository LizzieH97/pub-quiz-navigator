    ...
    <div className=" min-h-screen pb-2 sm:p-1 font-[family-name:var(--font-schoolbell)] bg-bark">
      <main className="flex flex-col w-full items-center sm:items-start">
        <section className="grid grid-cols-6 grid-rows-5 grid-flow-row">
          <div className="col-start-1 col-end-3 row-start-2 row-end-5 w-full h-full">
            <Title />
          </div>
          <p className="text-2xl p-7 col-start-3 col-end-7 row-start-2 text-cream">
          ...
          <p className="text-xl p-7 col-start-3 col-end-7 row-start-3 mt-50 text-cream">
